...
for(var child=div.firstChild;child!=null;child=child.nextSibling)if(hasClass(child,'NavPic')||hasClass(child,'NavContent'))child.style.display=disp}function voting12(){if(votingTrigger=document.getElementById('voting-trigger'))importScriptURI(wgServer+wgScript+'?title=MediaWiki:Voting12.js&action=raw&ctype=text/javascript&cversion='+encodeURIComponent(votingTrigger.innerHTML.replace(/\D+/g,'.')))}var metaBase='http://meta.wikimedia.org'
...
/* cache key: ruwiki:resourceloader:filter:minify-js:5:e095267e9fb0c22ce5e4df2f0c721a8e */